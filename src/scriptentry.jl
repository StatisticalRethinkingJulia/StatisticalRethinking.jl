...
script_dict = DataStructures.OrderedDict{AbstractString, Vector{ScriptEntry}}(
  ...
  "04" => [
    ...
    scriptentry("clip-07.0s.jl"),
    scriptentry("clip-07.1s.jl", doc = false),
    scriptentry("clip-38.0m.jl"), 
    scriptentry("clip-38.1m.jl", exe = false, doc = false), 
    scriptentry("clip-38.0s.jl"),
    scriptentry("clip-38.1s.jl", exe = false, doc = false),
    scriptentry("clip-38.2s.jl", nb = false, exe = false, doc = false),
    scriptentry("clip-38.3s.jl", nb = false, exe = false, doc = false),
    scriptentry("clip-38.4s.jl", nb = false, exe = false, doc = false),
    scriptentry("clip-38.5s.jl", nb = false, exe = false, doc = false),
    scriptentry("clip-38.6s.jl", nb = false, exe = false, doc = false),
    scriptentry("clip-38.7s.jl"),
    scriptentry("clip-43s.jl"),
    scriptentry("clip-43t.jl", exe = false, doc = false),
    scriptentry("clip-45-47s.jl"),
    scriptentry("clip-48-54s.jl")
  ],
  "05" => [
    scriptentry("clip-01s.jl", exe = false, doc = false)
  ],
  "08" => [
