...
script_dict = DataStructures.OrderedDict{AbstractString, Vector{ScriptEntry}}(
  ...
  "02" => [
    ...
    scriptentry("clip-08m.jl", exe = false, doc = true), 
  ...
  "04" => [
    ...
    scriptentry("m4.4m.jl", exe = false, doc = true), 
    scriptentry("m4.4s.jl"),
    scriptentry("clip-01-06.jl"),
    scriptentry("clip-07-13s.jl"),
    scriptentry("clip-14-20.jl"),
    scriptentry("clip-21-29s.jl"),
  ...
  "08" => [
    scriptentry("m8.1.jl", exe = false, doc = true),
    scriptentry("m8.2.jl", exe = false, doc = false),
    scriptentry("m8.3.jl", exe = false, doc = true),
  ...
  "12" => [
    ...
    scriptentry("m12.6.1s.jl"),
    scriptentry("m12.6.2s.jl")
  ]
);
