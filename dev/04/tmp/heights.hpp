...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(19, 17, "end", "/home/travis/build/StatisticalRethinkingJulia/StatisticalRethinking.jl/docs/build/04/tmp/heights.stan");
    return reader;
}
